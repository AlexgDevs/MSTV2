...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>Привязка почты к сайту</h1>
        </div>
        <div class="email-content">
            <h2 class="email-title">Добро пожаловать!</h2>
            <p class="email-text">
                Спасибо за привязку! Для ее завершения, 
                пожалуйста, введите следующий код подтверждения без пробелов:
            </p>
            ...
            <div class="warning-text">
                Никому не сообщайте этот код. Мы никогда не попросим вас предоставить его по телефону.
            </div>
        </div>
