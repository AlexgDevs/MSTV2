...
export const BeautyIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const TechIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const EducationIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const RepairIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const BusinessIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const DeleteIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const LogoutIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const XIcon: React.FC<IconProps> = ({ className, size = 24, color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
